      ...
      <div class="tab-pane fade in active" id="ann">
        ...
        <div class="box">
            <div class="box-header with-border">
              ...
              ?>
                <input type="hidden" id="id" value="<?php echo e($mydata->id); ?>">
                <h3 class="box-title"><?php echo e($mydata->title); ?>&nbsp;&nbsp;&nbsp;<span class="label <?php echo e($label); ?>"><?php echo e($area); ?></span></h3>
                <?php if(array_search(Auth::user()->usertype, ['admin', 'zoneadmin', 'woredaadmin']) !== false && Auth::user()->area == $mydata->code): ?>
              ...
              <div class="">
                  ...
                  <div class="table-responsive text-center">
                      ...
                      <tbody  id="products-list" name="products-list">
                          <?php $__currentLoopData = $doc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                          <tr>
                              <td><?php echo e($item->title); ?></td>
                              <td><?php echo e($item->description); ?></td>
                              <td> <a href="download/<?php echo e($item->title); ?>"> <button class="btn btn-primary"><span class="fa fa-download"></span>ኣውርድ</button> </a> 
