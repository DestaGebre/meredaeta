...
<div class="box box-primary">
    ...
    <?php
       $show_zone = $show_woreda = $hide_widabe = $hide_wahio = true;
    ?>
    <?php echo $__env->make('layouts.partials.filter_html', ['address' => 'meseretawiwdabe'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<div class="">
		...
		<div class="table-responsive text-center">
			<table class="table table-borderless" id="table">
				...
				<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mwidabe): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>					
				<tr class="item<?php echo e($mwidabe->widabeCode); ?>" >
                    <td><?php echo e($mwidabe->widabeCode); ?></td>
                    <input type="hidden" value="<?php echo e($mwidabe->widabes->tabiatat->zonat->zoneName); ?>">
                    <input type="hidden" value="<?php echo e($mwidabe->widabes->tabiatat->name); ?>">
					<td><?php echo e($mwidabe->widabes->tabiaName); ?></td>
					<td><?php echo e($mwidabe->widabeName); ?></td>
                    <td><?php echo e($mwidabe->type); ?></td>			
					<td><button class="edit-modal btn btn-info" data-info="<?php echo e($mwidabe->widabeCode); ?>,<?php echo e($mwidabe->widabeName); ?>,<?php echo e($mwidabe->widabes->tabiaCode); ?>,<?php echo e($mwidabe->widabes->tabiatat->woredacode); ?>,<?php echo e($mwidabe->widabes->tabiatat->zonat->zoneCode); ?>">
							<span class="glyphicon glyphicon-edit"></span> ኣስተኻኽል
						</button>
						<button class="delete-modal btn btn-danger"
							data-info="<?php echo e($mwidabe->widabeCode); ?>,<?php echo e($mwidabe->widabeName); ?>,<?php echo e($mwidabe->widabes->tabiaName); ?>">
