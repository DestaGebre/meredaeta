...
<?php $__env->startSection('main-content'); ?>
    ...
    <?php $bezhi = 0;?>
    <div class="container">
    <form method="get" action="<?php echo e(url('leaderlist')); ?>">
        ...
        <?php endif; ?>
        <?php if(array_search(Auth::user()->usertype, ['admin', 'zone','zoneadmin']) !== false): ?>
            <div class="col-md-2 col-sm-4 col-xs-4">
        ...
        <div class="col-md-5 col-md-offset-3 col-xs-12">
            <select name="show" id="show" class="form-control hide-print" >
                <option value="" selected disabled>~ዓይነት ኣመራርሓ~</option>
                <?php $__currentLoopData = $leader_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <form method="get" action="<?php echo e(url('leaderlistexcel')); ?>">
            <input type="hidden" name="zone" value="<?php echo e($zoneCode); ?>">
            <input type="hidden" name="show" value="<?php echo e($show_name); ?>">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mydata): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>                                     
     ...
     <div class="pull-right">                      
            <span style="bold"በዝሒ ኣባላት: <?php echo e($bezhi); ?>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        </div>      
</div><br>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mydata): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>                                     
                                <tr>
                                    ...
                                    <td class="hidden"><?php echo e($mydata->zoneworedaCode); ?></td>   
                                    ...
                                    <td><?php echo e($mydata->hitsuy->name); ?> <?php echo e($mydata->hitsuy->fname); ?></td>                          
                                    ...
                                    <td><?php echo e($mydata->assignedAssoc); ?></td>
                                    <td><?php echo e($mydata->memberType); ?></td>
