...
<?php $__env->startSection('main-content'); ?>
    ...
    <?php echo $__env->make('layouts.partials.filter_html', ['address' => 'memberlist'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
         ...
         <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
     <div>                      
            <span style="bold"በዝሒ ኣባላት: <?php echo e($bezhi); ?> &nbsp
        </div>         
	<form method="get" action="<?php echo e(url('memberlistexcel')); ?>">
					...
					<table class="table table-borderless" id="table2">
						<thead>
							<tr>
                                ...
                                <th class="text-center">ኣስተኻኽል</th>
						...
						<tbody>
							...
							<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mydata): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>										
							<tr>
                                <input type="hidden" value="<?php echo e($mydata->grossSalary); ?>">
                                <input type="hidden" value="<?php echo e($mydata->fileNumber); ?>">
								<td class="hidden"><?php echo e($mydata->hitsuyID); ?></td>	
								<td><a href="<?php echo e(url('memberhistory')); ?>/<?php echo e(str_replace('/', '_', $mydata->hitsuyID)); ?>" class="btn btn-success"><?php echo e($mydata->hitsuyID); ?></a></td>	
								<td><?php echo e($mydata->hitsuy->name); ?> <?php echo e($mydata->hitsuy->fname); ?> <?php echo e($mydata->hitsuy->gfname); ?></td>
								<td><?php echo e($mydata->hitsuy->gender); ?></td>
								<td><?php echo e((date('Y') - date('Y',strtotime($mydata->hitsuy->dob)))); ?></td>
								<td><?php echo e($mydata->hitsuy->birthPlace); ?></td>
								<td><?php echo e(App\DateConvert::toEthiopian(date('d/m/Y',strtotime($mydata->membershipDate)))); ?></td>
								<td><?php echo e($mydata->hitsuy->occupation); ?></td>
								<td><?php echo e($mydata->hitsuy->educationLevel); ?></td>
								<td><?php echo e(str_replace(',', '፣', $mydata->assignedAssoc)); ?></td>
								<td><?php echo e($mydata->membershipType); ?></td>
								<td><?php echo e($mydata->netSalary); ?></td>
								<!-- <td><?php echo e(floatval($mydata->netSalary)*0.015); ?></td> -->
                                <?php if(Auth::user() && Auth::user()->usertype != 'management'): ?> 
								<td><button class="addEducation-modal btn btn-success" data-info="<?php echo e($mydata->hitsuyID); ?>,<?php echo e($mydata->hitsuy->name); ?> <?php echo e($mydata->hitsuy->fname); ?> <?php echo e($mydata->hitsuy->gfname); ?>">
									<span class="glyphicon glyphicon-plus"></span></button>
								</td>
								<td><button class="addExprience-modal btn btn-success" data-info="<?php echo e($mydata->hitsuyID); ?>,<?php echo e($mydata->hitsuy->name); ?> <?php echo e($mydata->hitsuy->fname); ?> <?php echo e($mydata->hitsuy->gfname); ?>">
									<span class="glyphicon glyphicon-plus"></span></button>
								</td>
                                <td>
                                ...
                                <?php endif; ?>
								<!--<td>
									<button class="addPolitics-modal btn btn-success" data-info="<?php echo e($mydata->hitsuyID); ?>,<?php echo e($mydata->hitsuy->name); ?> <?php echo e($mydata->hitsuy->fname); ?> <?php echo e($mydata->hitsuy->gfname); ?>">
									<span class="glyphicon glyphicon-plus"></span></button>
								</td>			-->					
						   </tr>
                            <?php $bezhi +=1; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form"> 
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">ሽም
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fname">ሽም ኣቦ
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gfname">ሽም ኣቦ ሓጎ
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="gfname" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div> 
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gender">ፆታ<span class="text-danger">(*)</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" id="gender" required="required">
                                        <option selected disabled>~ፆታ~</option>
                                        <option>ተባ</option>
                                        <option>ኣን</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dob">ዝተወለደሉ ዕለት
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
...
<div id="addEdu" class="hidden">
        ...
        <div class="form-group col-sm-12 col-md-12">
            ...
            <label class="control-label col-md-1 col-sm-1" for="endDate">ዝወድአሉ/ትሉ:</label>
            <div class="col-md-4 col-sm-4 col-xs-4">
        ...
        <div class="form-group col-sm-12 col-md-12"> 
            ...
            <label class="control-label col-md-1 col-sm-1" for="salary">ደሞዝ:</label>
            <div class="col-md-4 col-sm-4 col-xs-4">
...
<?php $__env->startSection('scripts-extra'); ?>
	...
	<script>
     ...
     $(document).on('click', '.modify', function() {
        ...
        $('#fullName').val(stuff[2]);
        $('#name').val(stuff[4].split(' ')[0]);
        $('#fname').val(stuff[4].split(' ')[1]);
        $('#gfname').val(stuff[4].split(' ')[2]);
        $('#gender').val(stuff[5]);
        ...
        $('#assignedAssoc').val(stuff[11].split('፣'));
