...
<?php $__env->startSection('main-content'); ?>
    ...
    <?php echo $__env->make('layouts.partials.filter_html', ['address' => 'directpromotion'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    ...
                    <table class="table table-borderless" id="table2">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">ደረጃ ኣመራርሓ</th>
                                <!-- <th class="text-center">ወርሓዊ ኣባልነት ክፍሊት</th> -->
                                <th class="text-center">ኣስጋግር</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($mydata->hitsuy->position); ?></td>
                                ...
                                <td><button class="addEducation-modal btn btn-success" data-info="<?php echo e($mydata->hitsuyID); ?>,<?php echo e($mydata->hitsuy->name); ?> <?php echo e($mydata->hitsuy->fname); ?> <?php echo e($mydata->hitsuy->gfname); ?>">
                                    <span class="glyphicon glyphicon-edit"></span>ኣሰጋግር</button>
                                </td>
                                <!--<td>
...
<div id="addEdu" class="hidden">
        ...
        <div class="form-group col-sm-12 col-md-12">                     
            ...
            <label class="control-label col-md-1 col-sm-1" for="promotionLevel">ደረጃ ኣመራርሓ:</label>
            <div class="col-md-4 col-sm-4 col-xs-4">
                <select id="promotionLevel" name="promotionLevel" class="form-control">
        ...
        <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-5">                         
                          ...
                          <button type="button" id="promote" class="btn btn-success">መዝግብ</button>
                        </div>
                      </div>
  ...
  $('#promote').on('click', '', function() {
        data = {
            '_token': $('input[name=_token]').val(),                
                ...
                'promotionLevel': $('#promotionLevel').val(), };
        $.ajax({
            type: 'post',
            url: 'promote',
            data: data,
