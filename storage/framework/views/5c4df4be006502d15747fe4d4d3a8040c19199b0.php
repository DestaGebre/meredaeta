...
<div class="box box-primary">
    <div class="box-header with-border">
      <?php
       $show_zone = $show_woreda = $hide_wahio = true;
      ?>
      <?php echo $__env->make('layouts.partials.filter_html', ['address' => 'wahio'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="table-responsive text-center">
            ...
            <tbody  id="products-list" name="products-list">
                ...
                <tr class="item<?php echo e($item->id); ?>" >
                    ...
                    <input type="hidden" value="<?php echo e($item->wahiosmw->widabes->tabiatat->zonat->zoneName); ?>">
                    <input type="hidden" value="<?php echo e($item->wahiosmw->widabes->tabiatat->name); ?>">
                    <input type="hidden" value="<?php echo e($item->wahiosmw->widabes->tabiaName); ?>">
                    <td><?php echo e($item->wahiosmw->widabeName); ?></td>
                    <td><?php echo e($item->wahioName); ?></td>
                    <td><?php echo e($item->type); ?></td>
                    
                    <td><button class="edit-modal btn btn-info"
                            data-info="<?php echo e($item->id); ?>,<?php echo e($item->wahioName); ?>">
