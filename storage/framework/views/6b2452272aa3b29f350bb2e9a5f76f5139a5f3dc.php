...
<div class="box box-primary">
    ...
    ?>
    <?php echo $__env->make('layouts.partials.filter_html', ['address' => 'woreda'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<div class="">
		...
		<div class="table-responsive text-center">
			<table class="table table-borderless" id="table">
				...
				<tr class="item<?php echo e($item->woredacode); ?>" >
				   
					<td><?php echo e($item->woredacode); ?></td>
                    <td><?php echo e($item->zonat->zoneName); ?></td>
					<td><?php echo e($item->name); ?></td>
					<td><?php echo e($item->isUrban); ?></td>
					
					<td><button class="edit-modal btn btn-info"
							data-info="<?php echo e($item->woredacode); ?>,<?php echo e($item->zonat->zoneName); ?>,<?php echo e($item->woredacode); ?>,<?php echo e($item->name); ?>,<?php echo e($item->isUrban); ?>,<?php echo e($item->zoneCode); ?>">
							<span class="glyphicon glyphicon-edit"></span> ኣስተኻኽል
						</button>
						<button class="delete-modal btn btn-danger"
							data-info="<?php echo e($item->woredacode); ?>,<?php echo e($item->zonat->zoneName); ?>,<?php echo e($item->woredacode); ?>,<?php echo e($item->name); ?>,<?php echo e($item->isUrban); ?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						 ...
						 <select class="form-control"  id ="zoneCodeselect" >
						   ...
						   <?php $__currentLoopData = $zobadata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
							  <option value="<?php echo e($item->zoneCode); ?>"><?php echo e($item->zoneName); ?></option>
						  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
