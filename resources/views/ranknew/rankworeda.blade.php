...
<div class="box box-primary">
    <div class="box-header with-border">
      ...
      ?>
      @include('layouts.partials.filter_html', ['address' => 'rankworeda'])
        
        <div class="">
            {{ csrf_field() }}
            <div class="table-responsive text-center">
              <div class="pull-left">
                <form method="get" action="{{ URL('rankworedalist')}}">
                ...
                <thead>
                    <tr>
                        <th class="text-center">ኩሎም ምረፅ<th>
            ...
            <tbody>
                        @foreach ($data as $myworeda)
                          <tr>
                            ...
                            <input type="hidden" value="{{ $myworeda->zoneCode }}">
