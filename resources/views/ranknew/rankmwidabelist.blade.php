...
@section('main-content')
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="myTable">
                <?php $show_zone = $show_woreda = $hide_widabe = $hide_wahio = $show_year = $show_rank = true; ?>
                @include('layouts.partials.filter_html', ['address' => 'rankmwidabelist'])
                        ...
                        <tbody>
                            @foreach ($data as $mywidabe)
                              <tr>
                                ...
                                <input type="hidden" value="{{$mywidabe->id}}">
...
@section('scripts-extra')
    ...
    $(document).on('click', '.edit-button', function() {
        ...
        $('#result').val($(row.children()[4]).html());
        id = $(row.children()[5]).val();
    ...
    $(document).on('click', '#update', function() {
        $.ajax({
            ...
            if(data[0] == true){
                ...
                $(row.children()[4]).html($('#result').val());
                $('#memeberID').val('');
                $('#ryear').val('');
                // $('#half').val('');
                $('#result').val('');
