...
<body>
	<div class="box box-primary">
		...
		<div class="pull-right">                      
            <a class="btn switchBtn btn-info" href="{{ url('mediumleader#step-1') }}"><span class="glyphicon glyphicon-arrow-up"></span></a>
        </div>
			
			<div class="myTable">
                @include('layouts.partials.filter_html', ['address' => 'mdmleaderslist'])
				<div class="" style="height: 50px;">	
				  <form method="GET" action= "{{URL('mediumleaderform')}}" class="form-inline">			
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                    ...
                                    <a href="{{ url('mediumleaderdetails') }}?id={{ str_replace('/', '_', $mydata->hitsuyID) }}&year={{$mydata->year}}&period={{$mydata->half}}" class="btn btn-success">ዝርዝር ርኣይ</a>
