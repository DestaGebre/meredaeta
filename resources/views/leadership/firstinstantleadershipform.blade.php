   ...
   <div class=""> 
        ...
        <div id="smartwizard">
            <ul>
                ...
                <li><a href="#step-3">ቅጥዒ 3<br /><small>ካብ ቑፅሪ 3 ክሳብ ቑፅሪ 8</small></a></li>
            </ul>
            ...
            <div>               
                <div id="step-1" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result5" type="number" min="0" max="5" placeholder="ዝረኸቦ ውፅኢት ካብ 5" name="Result5"  required="required" value="{{$details ? $details->result5 : ''}}">
                        </div>
                    </div>               
                ...
                <div id="step-2" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result9" name="Result9"   type="number" min="0" max="15" placeholder="ዝረኸቦ ውፅኢት ካብ 15" required="required" value="{{$details ? $details->result9 : ''}}">
                        </div>
                    </div>
                ...
                <div id="step-3" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result10" name="Result10"   type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" required="required" value="{{$details ? $details->result10 : ''}}">
                        </div>
                    </div>
...
$(document).ready(function(){
    ...
    var btnFinish = $('<button></button>').text('ዛዝም')
                                     ...
                                     .on('click', function(){ 
                                       $.ajax({
                                        type: 'post',
                                        url: {!! $details ? "'editfirstinstantleader'" : "'firstinstantleader'" !!},
                                        data: {
                                            'id': $('#evaluationId').val(),
