...
ናይ ታሕተዋይ ኣመራርሓ {{ $name }}[መለለዪ ቑፅሪ፥ {{ $id }}] ገምጋም {{ $year }} [{{ $period }}]
@endsection
...
<div class="box box-primary">
    ...
    <div id="myDetails">
        <div class="pull-left">
                <a class="btn switchBtn btn-info" href="{{ url('lowleader') }}?id={{ str_replace('/', '_', $data->hitsuyID) }}&year={{$data->year}}&period={{$data->half}}"><span class="glyphicon glyphicon-edit"></span>ኣስተኻኽል</a>
...
<div class="form-group col-sm-12 col-md-12"> 
                        ...
                        <div class="col-sm-12 col-md-12">
                            <input type="text" class="form-control" id="model" value="{{$data->model}}" name="model" required readonly>
                        </div><br/>
                    ...
                    <div class="form-group col-sm-12 col-md-12"> 
                        ...
                        <div class="col-sm-12 col-md-12">
                            <input type="text" class="form-control" id="evaluation" value="{{$data->evaluation}}" name="evaluation" required readonly>
                        </div><br/>
