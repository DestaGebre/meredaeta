   ...
   <div class=""> 
        ...
        <div id="smartwizard">
            <ul>
                ...
                <li><a href="#step-2">ቅጥዒ 2<br /><small>ናይ ልምዓት፥ ሰናይ ምምሕዳር ተግባራትን</small></a></li>
                <li><a href="#step-3">ቅጥዒ 3<br /><small>ካብ ቑፅሪ 3 ክሳብ ቑፅሪ 9</small></a></li>
            </ul>
            ...
            <div>               
                <div id="step-1" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12"> 
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result1" type="number" min="0" max="11" placeholder="ዝረኸቦ ውፅኢት ካብ 11" name="Result1"  required="required" value="{{$details ? $details->result1 : ''}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12"> 
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result4" type="number" min="0" max="6" placeholder="ዝረኸቦ ውፅኢት ካብ 4" name="Result4"  required="required" value="{{$details ? $details->result4 : ''}}">
                        </div>
                    </div>                 
                    <div class="form-group col-sm-12 col-md-12"> 
                      <label class="col-sm-12 col-md-12 control-label" for="answer5">1.3.2 ምስ ኣባላትን መሳርሕቱን ዘለዎ ዝምድና፤</label>
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result5" type="number" min="0" max="2" placeholder="ዝረኸቦ ውፅኢት ካብ 2" name="Result5"  required="required" value="{{$details ? $details->result5 : ''}}">
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-12"> 
                      <label class="col-sm-12 col-md-12 control-label" for="answer6">1.3.3 ህዝባዊ ውግንንኡን ዴሞክራሲያዊ ኣተኣላልይኡን ዝምልከት፤</label>
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result6" type="number" min="0" max="2" placeholder="ዝረኸቦ ውፅኢት ካብ 2" name="Result6"  required="required" value="{{$details ? $details->result6 : ''}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result7" type="number" min="0" max="2" placeholder="ዝረኸቦ ውፅኢት ካብ 2" name="Result7"  required="required" value="{{$details ? $details->result7 : ''}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result8" type="number" min="0" max="2" placeholder="ዝረኸቦ ውፅኢት ካብ 2" name="Result8"  required="required" value="{{$details ? $details->result8 : ''}}">
                        </div>
                    </div>
                ...
                <div id="step-2" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12"> 
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result9" type="number" min="0" max="11" placeholder="ዝረኸቦ ውፅኢት ካብ 11" name="Result9"  required="required" value="{{$details ? $details->result9 : ''}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result10" type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" name="Result10"  required="required" value="{{$details ? $details->result10 : ''}}">
                        </div>
                    </div>                    
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea rows="2" class="form-control" id="answer11" name="Answer11" required> {{$details ? $details->answer11 : ''}}</textarea>
                        </div><br/>
                        <label class="col-sm-12 col-md-12 control-label" for="result11"></label>
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result11" name="Result11"   type="number" min="0" max="14" placeholder="ዝረኸቦ ውፅኢት ካብ 14" required="required" value="{{$details ? $details->result11 : ''}}">
                        </div>
                    </div>
                ...
                <div id="step-3" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea rows="2" class="form-control" id="answer12" name="Answer12" required> {{$details ? $details->answer12 : ''}}</textarea>
                        </div><br/>
                        <label class="col-sm-12 col-md-12 control-label" for="result12"></label>
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result12" name="Result12"   type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" required="required" value="{{$details ? $details->result12 : ''}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea rows="2" class="form-control" id="answer13" name="Answer13" required> {{$details ? $details->answer13 : ''}}</textarea>
                        </div><br/>
                        <label class="col-sm-12 col-md-12 control-label" for="result13"></label>
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result13" name="Result13"   type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" required="required" value="{{$details ? $details->result13 : ''}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea rows="2" class="form-control" id="answer14" name="Answer14" required> {{$details ? $details->answer14 : ''}}</textarea>
                        </div>                        
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea rows="2" class="form-control" id="answer15" name="Answer15" required> {{$details ? $details->answer15 : ''}}</textarea>
                        </div>                        
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">
                        <div class="col-sm-12 col-md-3">
                            <input type="year" class="form-control" id="year" name="year" placeholder="ዓመተምህረት"  value="{{$details ? $details->year : ''}}" required>
                        </div>                        
                    </div>
                    <!-- <div class="form-group col-sm-12 col-md-12">
                        <div class="col-sm-12 col-md-3">
                            <select type="half" class="form-control" id="half" name="half"  value="{{$details ? $details->half : ''}} required>
...
$(document).ready(function(){
    ...
    var btnFinish = $('<button></button>').text('ዛዝም')
                                     ...
                                     .on('click', function(){ 
                                       $.ajax({
                                        type: 'post',
                                        url: {!! $details ? "'edittopleader'" : "'topleader'" !!},
                                        data: {
                                            'id': $('#evaluationId').val(),
