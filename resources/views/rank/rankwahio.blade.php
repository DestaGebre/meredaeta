...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="">
          ...
          ?>
          @include('layouts.partials.filter_html', ['address' => 'rankwahio'])
            {{ csrf_field() }}
            <div class="table-responsive text-center">
              <div class="pull-left">
                <form method="get" action="{{ URL('rankwahiolist')}}">
              ...
              <div class="pull-right">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center">ኮድ ዋህዮ</th>                     
            ...
            <tbody>
                        @foreach ($data as $mywahio)
                          <tr>
                            ...
                            <td>{{ $collectionhalf[$mywahio->id] }}</td>
