...
@section('scripts-extra')
    ...
    $(document).on('click', '.delete-button', function() {
      row = $($($(this).parent()).parent());
        var id = $(row.children()[1]).html();
        var name = $(row.children()[2]).html();
        var year = $(row.children()[4]).html();
        var half = $(row.children()[5]).html();
    ...
    $(document).on('click', '.edit-button', function() {
        row = $($($(this).parent()).parent());
        $('#memeberID').val($(row.children()[1]).html());
        $('#ryear').val($(row.children()[4]).html());
        $('#half').val($(row.children()[5]).html());
        $('#result').val($(row.children()[6]).html());
