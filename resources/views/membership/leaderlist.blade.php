...
@section('main-content')
    ...
    <?php $bezhi = 0;?>
    <div class="container">
    <form method="get" action="{{ url('leaderlist') }}">
    ...
    <form method="get" action="{{ url('leaderlistexcel') }}">
            <input type="hidden" name="zone" value="{{ $zoneCode }}">
            <input type="hidden" name="show" value="{{ $show_name }}">
    ...
    @foreach ($data as $mydata)                                     
     ...
     <div class="pull-right">                      
            <span style="bold"በዝሒ ኣባላት: {{ $bezhi }}&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        </div>      
</div><br>
