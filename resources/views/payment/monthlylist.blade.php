...
@section('main-content')
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="myTable">
                <?php $show_zone = $show_woreda = $hide_wahio = $show_year = $show_month = $paid_or_not = true; ?>
                @include('layouts.partials.filter_html', ['address' => 'monthlylist'])
                    ...
                    <table class="table table-borderless" id="table2">
                        <thead>
                            <tr>
                              ...
                              <th class="text-center">ክፍሊት</th>
                              <th class="text-center">ዓመት</th>
                              <th class="text-center">ወርሒ</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{ $myyearly->name }} {{ $myyearly->fname }} {{ $myyearly->gfname }}</td>
                              <td>{{ $myyearly->occupation }}</td> 
                              <td>{{ $myyearly->amount }}</td>
                              <td>{{ $myyearly->year }}</td>
                              <td>{{ $myyearly->month }}</td>
                            </tr>
                          @endforeach
                        </tbody>
                        </table>
