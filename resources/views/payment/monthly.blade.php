...
<div class="box box-primary">
    <div class="box-header with-border">
      ...
      ?>
        @include('layouts.partials.filter_html', ['address' => 'monthly'])
        <div class=" ">
            {{ csrf_field() }}

            <div class="table-responsive text-center">
              <div class="pull-left">
              <form method="get" action="{{ URL('monthlylist')}}">
            ...
            <tbody>
                         @foreach ($data as $mymonthly)
                           @if(true/*$mymonthly->hitsuy->occupation=="ሲቪል ሰርቫንት"||$mymonthly->hitsuy->occupation=="መምህር"*/)
                          <tr>
