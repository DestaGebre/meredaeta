...
class KetemaReportNew extends Controller
{
    public function index(Request $request){
        ...
        if($request->year && $request->quarter && (array_search($request->quarter, $quarter_names) !== false)){
            ...
            $st = $temp_st;
            return view('report.ketema_new', $this->loadDataKetema($zoneCode, $year, $this_quarter));
        }
        ...
        if($zoneName == 'ኩሎም'){
            ...
            return view('report.ketema_new', $new_arr);
        }
        return view('report.ketema_new', $arr['ketema'][$zoneName]);
    }
    private function loadDataKetema($zoneCode, $year, $this_quarter){
        ...
        foreach ($woredas as $woreda) {
            ...
            $row_plan_deant = [$woreda['name'], ($base_data ? $base_data['plan_deant'][$k][2] : 0), 0, ($base_data ? $base_data['plan_deant'][$k][4] : 0), 0, ($base_data ? $base_data['plan_deant'][$k][6] : 0), 0, ($base_data ? $base_data['plan_deant'][$k][8] : 0), 0, ($base_data ? $base_data['plan_deant'][$k][10] : 0), 0, ($base_data ? $base_data['plan_deant'][$k][2] : 0), 0, 0,];
            ...
            $row_plan_all = [$woreda['name'], ($base_data ? $base_data['plan_all'][$k][2] : 0), 0, 0, ($base_data ? $base_data['plan_all'][$k][6] : 0), 0, 0, ($base_data ? $base_data['plan_all'][$k][10] : 0), 0, 0, ''];
            $row_model_members = [$woreda['name'], ($base_data ? $base_data['model_members'][$k][2] : 0), 0, 0, ($base_data ? $base_data['plan_all'][$k][6] : 0), 0, 0, 0, 0, 0, 0, 0, 0, ''];
            ...
            // Wesekin gudletin table
            {
                ...
                //TODO University
                $row_weseking_gudletin[9] = 0;
                // Transfer::where('oldzone', $zoneCode)
