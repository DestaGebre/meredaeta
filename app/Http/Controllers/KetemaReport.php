        ...
        foreach ($woredas as $woreda) {
            ...
            foreach ($tabias as $tabia) {
                ...
                if($tabia['isUrban'] == 'ከተማ'){
                    ...
                    // TODO ተኣጊዱ ዝነበረ
                    echo 'here';
                    $row_weseking_gudletin[4] += 5 + DB::table('unsuspend')
                ...
                ->whereBetween('unsuspend.unsuspendDate', [Carbon::createFromDate(explode("/", $quarter[0])[2], explode("/", $quarter[0])[1], explode("/", $quarter[0])[0]), Carbon::createFromDate(explode("/", $quarter[1])[2], explode("/", $quarter[1])[1], explode("/", $quarter[1])[0])]);
